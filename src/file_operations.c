...
/*  Συνάρτηση checkFreeSpace() τύπου int με παράμετρους τα const char *path long file_size 
    η οποία υπολογίζει τον ελέυθερο χώρο που υπάρχει στο εκάστοτε σύστημά και ελέγχει
    αν το μέγεθος του αρχείου χωράει στον δίσκο μας. Σε αντίθετη περίπτωση  εκτυπώνει τα
    αντίστοιχα μηνύμα σφάλματος και τους αντίστοιχους κωδικούς τους. */
...
/*  Συνάρτηση openFile() τύπου FILE* με παράμετρους τα const char *file_path, const char *mode 
    ...
    εκτυπώνει τα αντίστοιχα μηνύμα σφάλματος και τους αντίστοιχους κωδικούς τους.*/
...
/*  Συνάρτηση copyFile() τύπου int με παράμετρους τα FILE *source_file, FILE *dest_file,
    int buffer_size, double *cpu_time_used η οποία αντιγράφει στην μία περίπτωση με χρήση
    του buffer, του οποίου το μέγεθος έχει δωθεί από το χρήστη, και στην άλλη περίπτωση 
    με το standard buffer I/O. Επίσης, γίνεται χρονομέτηση της διαδικασίας αυτής και εκτυπώνεται
    ο χρόνος που απαιτείται να ολοκληρωθεί η διαδιακασία. Σε αντίθετη περίπτωση εκτυπώνει 
    τα αντίστοιχα μηνύμα σφάλματος και τους αντίστοιχους κωδικούς τους.*/
